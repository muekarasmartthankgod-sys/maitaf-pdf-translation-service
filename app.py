...
# --- FRONTEND SELECTION INTERFACE (TOP OF THE PAGE) ---
...
if not api_key:
    ...
    # --- DOCUMENT DROP ZONE sits below selection controls ---
                    ...
                    for page in doc:
                        ...
                        if blocks_to_translate:
                            ...
                            for idx, instance in enumerate(valid_instances):
                                ...
                                # Width Boundary Control: Prevents left-side items from overlapping the right side columns
